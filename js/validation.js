...
document.addEventListener(
    ...
    function(){
        ...
        initializeCharacterCounter("religion", 25);
        initializeCharacterCounter("gotra", 25);
        initializeCharacterCounter("rashi", 25);
        initializeCharacterCounter("gan", 25);
        initializeCharacterCounter("height", 25);
